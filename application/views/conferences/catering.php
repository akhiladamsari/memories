            ...
            <div class="col-md-3">
                <ul class="list-group sidebar-nav" id="sidebar-nav">
                    ...
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_conf_halls">Halls</a>
                    </li>
                    <!-- End Typography -->
                    <!-- Components -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_conf_hall_deco">Hall Decorations</a>
                    </li>
                    <!-- End Components -->
                    <!-- Icons -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_conf_catering">Catering</a>
                    </li>
                    <!-- End Icons -->
                    <!-- Carousels -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_conf_photo">Photography & Videography</a>
                    </li>
                    <!-- End Accordion and Tabs -->
                    <!-- Animate On Scroll -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_conf_sounds">Sounds</a>
                    </li>
                    <!-- End Animate On Scroll -->
                    <!-- Grid System -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_conf_printing">Prinings</a>
                    </li>
                    <!-- End Grid System -->
                </ul>
            </div>
