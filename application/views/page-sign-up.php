    ...
    <div class="container background-white">
        <div class="row margin-vert-30">
            ...
            <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                <form class="signup-page margin-top-20" method="post" action="<?php echo base_url(); ?>sign_up/add_user">
                    ...
                    <input class="form-control margin-bottom-20" type="text" name="name" value="<?php set_value('name','Name')?>">
                    <label>Email Address
                        <span class="color-red">*</span>
                    </label>
                    <input class="form-control margin-bottom-20" type="text" name="email" value="<?php $this->input->post('email')?>">
                    <label>Telephone Number
                        <span class="color-red">*</span>
                    <input class="form-control margin-bottom-20" type="text" name="tel" value="<?php $this->input->post('tel')?>">
                    <label>User Name
                        <span class="color-red">*</span>
                    </label>
                    <input class="form-control margin-bottom-20" type="text" name="username" value="<?php $this->input->post('username')?>">
                    <div class="row">
                        <div class="col-sm-6">
                            <label>Password
                                <span class="color-red">*</span>
