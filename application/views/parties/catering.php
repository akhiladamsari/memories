            ...
            <div class="col-md-3">
                <ul class="list-group sidebar-nav" id="sidebar-nav">
                    ...
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_halls">Halls</a>
                    </li>
                    <!-- End Typography -->
                    <!-- Components -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_hall_deco">Hall Decorations</a>
                    </li>
                    <!-- End Components -->
                    <!-- Icons -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_catering">Catering</a>
                    </li>
                    <!-- End Icons -->
                    <!-- Testimonials -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_dresses">Dresses</a>
                    </li>
                    <!-- End Testimonials -->
                    <!-- Accordion and Tabs -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_makeup">Make-up</a>
                    </li>
                    <!-- End Accordion and Tabs -->
                    <!-- Buttons -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_cakes">Cakes</a>
                    </li>
                    <!-- End Buttons -->
                    <!-- Carousels -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_photo">Photography & Videography</a>
                    </li>
                    <!-- End Accordion and Tabs -->
                    <!-- Animate On Scroll -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_sounds">Sounds</a>
                    </li>
                    <!-- End Animate On Scroll -->
                    <!-- Grid System -->
                    <li class="list-group-item list-toggle">
                        <a href="<?php echo base_url(); ?>page_nav/goto_wed_printing">Prinings</a>
                    </li>
                    <!-- End Grid System -->
                </ul>
            </div>
